...
namespace Hadia.Migrations
{
    ...
    [Migration("20190105045407_MakeUniqueMemberIdandPostIdInPostLike")]
    partial class MakeUniqueMemberIdandPostIdInPostLike
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hadia.Com_ExecutiveMember", b =>
                {
                    ...
                    b.ToTable("Com_ExecutiveMembers");
                });
            ...
            modelBuilder.Entity("Hadia.Models.DomainModels.Haf_Master", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("Haf_Masters");
                });

            modelBuilder.Entity("Hadia.Models.DomainModels.Haf_YearMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Hadia.Models.DomainModels.Post_CommentView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Hadia.Models.DomainModels.Res_Master", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Hadia.Com_ExecutiveMember", b =>
                {
                    b.HasOne("Hadia.Models.DomainModels.Mem_Master", "CreatedBy")
                        .WithMany("ExCreatedBy")
                        .HasForeignKey("CLogin")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Hadia.Models.DomainModels.Com_Master", "HadiaCommittee")
                        .WithMany("ExecMembers")
                        .HasForeignKey("CommitteeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Hadia.Models.DomainModels.Mem_Master", "ModifiedBy")
                        .WithMany("ExModifiedBy")
            ...
            modelBuilder.Entity("Hadia.Models.DomainModels.Haf_Master", b =>
                {
                    ...
                    b.HasOne("Hadia.Models.DomainModels.Haf_YearMaster", "HadiyaYear")
                        .WithMany("HafMasters")
            ...
            modelBuilder.Entity("Hadia.Models.DomainModels.Mem_Master", b =>
                {
                    b.HasOne("Hadia.Models.DomainModels.Sett_DeviceInfoLog", "ActiveDevice")
                        .WithMany("Members")
                        .HasForeignKey("ActiveDeviceId");
            ...
            modelBuilder.Entity("Hadia.Models.DomainModels.Res_Views", b =>
                {
                    ...
                    b.HasOne("Hadia.Models.DomainModels.Res_Master", "Resource")
